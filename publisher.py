...
# ============================================================
# NVIDIA NIM API — OpenAI SDK with Nemotron Thinking Support
# ============================================================
def call_nvidia(prompt, model=None, max_tokens=2048):
    """Call NVIDIA NIM using OpenAI SDK. Handles thinking models safely for automation."""
    if model is None:
        model = BLOG_MODEL
    ...
    kwargs = {
        ...
        "stream": False  # MUST BE FALSE. Streaming breaks WordPress posting.
    }

    # If using the Nemotron thinking model, add special parameters
    ...
    try:
        ...
        # The SDK automatically separates reasoning from final content.
        # We ONLY want the final content for the blog post.
        if completion.choices[0].message.content is not None:
            return completion.choices[0].message.content
        
        return None
    except Exception as e:
        print(f"  ⚠ NVIDIA error: {str(e)[:200]}")
        return None
...
def main():
    print("=" * 55)
    print(f"🤖 AI News Auto-Publisher v2 (NVIDIA Nemotron)")
    ...
    for i, item in enumerate(new_items, 1):
        ...
        print("  🔄 Generating blog post (Nemotron is thinking)...")
